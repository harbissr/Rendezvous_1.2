"""
Django settings for rendezvous_proj project.
...
ROOT_URLCONF = "rendezvous_proj.urls"
...
WSGI_APPLICATION = "rendezvous_proj.wsgi.application"
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:5173",  # React app alternative origin
]
